            ...
            <footer className="bg-gray-100 py-8 px-10 text-gray-800 flex justify-around">
                <div className="mt-10 mb-10 container mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <ul className="space-y-2 text-lg">
                            ...
                            <Link href="#"><li className="py-2">Artificial Intelligence (AI) and Deep Learning</li></Link>
                            <Link href="#"><li className="py-2">Ambient Computing and IoT</li></Link>
                            <Link href="#"><li className="py-2">Genomics and Bioinformatics</li></Link>
                            <Link href="#"><li className="py-2">Network Programmability and Automation</li></Link>
                        </ul>
                    </div>
                    <div>
                        <h3 className="text-xl font-bold mb-4">Social Links</h3>
                        <div className="flex space-x-4 mb-4 py-2">
                            <Link href="#"><FaFacebookF className="text-white w-10 h-10 rounded-full bg-blue-800 pt-1 pb-1"/></Link>
                            <Link href="#"><FaYoutube className="text-white w-10 h-10 rounded-full bg-red-600 pt-1 pb-1"/></Link>
                            <Link href="#"><FaTwitter className="text-white w-10 h-10 rounded-full bg-blue-500 pt-1 pb-1"/></Link>
                            <Link href="#"><FaInstagram className="instagram text-white w-10 h-10 rounded-full pt-1 pb-1"/></Link>
                            <Link href="#"><FaTiktok className="text-white w-10 h-10 rounded-full bg-black pt-1 pb-1"/></Link>
                        </div>
